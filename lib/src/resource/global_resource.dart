...
/// appropriate mapper interface and registering it with `rdf_mapper`.
///
...
/// `@RdfProperty`) in your class and registered within initRdfMapper. This
/// generated mapper will create RDF triples with the instance's IRI as the
/// subject for each annotated property.
///
...
/// ```
class RdfGlobalResource extends BaseMapping<GlobalResourceMapper>
